...
public class MensajesConfigManager {
    ...
    public void setMessages() {
        ...
        MessageManager msgManager = new MessageManager(messages.getString("prefix"));
    ...
    public void reloadMessages() {
        ...
        defConfigStream = new InputStreamReader(plugin.getResource("messages.yml"), StandardCharsets.UTF_8);
